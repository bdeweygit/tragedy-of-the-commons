// https://stackoverflow.com/questions/36368919/scrollable-image-with-pinch-to-zoom/37449923
...
export default class Zoomable extends Component {
    ...
    _onLayout(event) {
        ...
        const offsetTop = layout.height > this.props.imageHeight * zoom ?
    ...
    render() {
        ...
        return (
          ...
          >
            {this.props.renderChild(childStyle)}
          </View>
        );
    }
